...
// Family-3 retirement (audit 2026-07-31): the `cf_dynamical_correlator`
// wrapper (a template with ZERO instantiation sites) delegated to the
// now-deleted legacy `::compute_dynamical_correlation_state_cf`. The
// |psi> -> S(omega) continued-fraction primitive is
// `ed::observables::cf_spectral_from_vector` (cf_spectral_kernel.h).
