// =============================================================================
// examples/spectral/ground_state_dssf/cpu_spatial.cpp
//
// spectral | ground-state DSSF | CPU (OpenMP) | cyclic translation group Z_N
//
// dynamical structure factor S_zz(omega) at three omega points. Twin: examples/spectral/ground_state_dssf/cpu_spatial.py
//
