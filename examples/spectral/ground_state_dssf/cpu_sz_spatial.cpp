// =============================================================================
// examples/spectral/ground_state_dssf/cpu_sz_spatial.cpp
//
// spectral | ground-state DSSF | CPU (OpenMP) | U(1)-Sz x cyclic translation
//
// dynamical structure factor S_zz(omega) at three omega points. Twin: examples/spectral/ground_state_dssf/cpu_sz_spatial.py
//
