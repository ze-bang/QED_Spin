// =============================================================================
// examples/spectral/ground_state_dssf/mpi_spatial.cpp
//
// spectral | ground-state DSSF | MPI (distributed) | cyclic translation group Z_N
//
// dynamical structure factor S_zz(omega) at three omega points. Twin: examples/spectral/ground_state_dssf/mpi_spatial.py
//
