// =============================================================================
// examples/spectral/ground_state_dssf/mpi_sz.cpp
//
// spectral | ground-state DSSF | MPI (distributed) | U(1)-Sz, half-filled (Sz=0, n_up=N/2)
//
// dynamical structure factor S_zz(omega) at three omega points. Twin: examples/spectral/ground_state_dssf/mpi_sz.py
//
