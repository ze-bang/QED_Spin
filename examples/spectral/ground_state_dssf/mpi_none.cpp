// =============================================================================
// examples/spectral/ground_state_dssf/mpi_none.cpp
//
// spectral | ground-state DSSF | MPI (distributed) | full Hilbert (no symmetry)
//
// dynamical structure factor S_zz(omega) at three omega points. Twin: examples/spectral/ground_state_dssf/mpi_none.py
//
