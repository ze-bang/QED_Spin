// =============================================================================
// examples/spectral/ground_state_dssf/mpi_gpu_sz_spatial.cpp
//
// spectral | ground-state DSSF | multi-rank multi-GPU (NCCL) | U(1)-Sz x cyclic translation
//
// dynamical structure factor S_zz(omega) at three omega points. Twin: examples/spectral/ground_state_dssf/mpi_gpu_sz_spatial.py
//
