// =============================================================================
// examples/spectral/ground_state_dssf/gpu_none.cpp
//
// spectral | ground-state DSSF | single GPU (cuBLAS/cuSPARSE) | full Hilbert (no symmetry)
//
// dynamical structure factor S_zz(omega) at three omega points. Twin: examples/spectral/ground_state_dssf/gpu_none.py
//
