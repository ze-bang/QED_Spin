// =============================================================================
// examples/spectral/ground_state_dssf/mpi_sz_spatial.cpp
//
// spectral | ground-state DSSF | MPI (distributed) | U(1)-Sz x cyclic translation
//
// dynamical structure factor S_zz(omega) at three omega points. Twin: examples/spectral/ground_state_dssf/mpi_sz_spatial.py
//
