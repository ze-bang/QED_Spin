// =============================================================================
// examples/spectral/single_expectation/cpu_none.cpp
//
// spectral | single expectation | CPU (OpenMP) | full Hilbert (no symmetry)
//
// ground-state expectation of H via qed.solve. Twin: examples/spectral/single_expectation/cpu_none.py
//
