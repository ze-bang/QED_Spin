// =============================================================================
// examples/spectral/single_expectation/gpu_none.cpp
//
// spectral | single expectation | single GPU (cuBLAS/cuSPARSE) | full Hilbert (no symmetry)
//
// ground-state expectation of H via qed.solve. Twin: examples/spectral/single_expectation/gpu_none.py
//
