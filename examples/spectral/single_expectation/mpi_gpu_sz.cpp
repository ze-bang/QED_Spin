// =============================================================================
// examples/spectral/single_expectation/mpi_gpu_sz.cpp
//
// spectral | single expectation | multi-rank multi-GPU (NCCL) | U(1)-Sz, half-filled (Sz=0, n_up=N/2)
//
// ground-state expectation of H via qed.solve. Twin: examples/spectral/single_expectation/mpi_gpu_sz.py
//
