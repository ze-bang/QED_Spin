// =============================================================================
// examples/spectral/single_expectation/gpu_sz.cpp
//
// spectral | single expectation | single GPU (cuBLAS/cuSPARSE) | U(1)-Sz, half-filled (Sz=0, n_up=N/2)
//
// ground-state expectation of H via qed.solve. Twin: examples/spectral/single_expectation/gpu_sz.py
//
