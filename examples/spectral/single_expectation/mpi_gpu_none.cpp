// =============================================================================
// examples/spectral/single_expectation/mpi_gpu_none.cpp
//
// spectral | single expectation | multi-rank multi-GPU (NCCL) | full Hilbert (no symmetry)
//
// ground-state expectation of H via qed.solve. Twin: examples/spectral/single_expectation/mpi_gpu_none.py
//
