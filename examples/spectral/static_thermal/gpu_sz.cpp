// =============================================================================
// examples/spectral/static_thermal/gpu_sz.cpp
//
// spectral | static thermal | single GPU (cuBLAS/cuSPARSE) | U(1)-Sz, half-filled (Sz=0, n_up=N/2)
//
// static thermodynamic averages at a single T via qed.thermal. Twin: examples/spectral/static_thermal/gpu_sz.py
//
