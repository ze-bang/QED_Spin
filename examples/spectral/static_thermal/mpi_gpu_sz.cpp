// =============================================================================
// examples/spectral/static_thermal/mpi_gpu_sz.cpp
//
// spectral | static thermal | multi-rank multi-GPU (NCCL) | U(1)-Sz, half-filled (Sz=0, n_up=N/2)
//
// static thermodynamic averages at a single T via qed.thermal. Twin: examples/spectral/static_thermal/mpi_gpu_sz.py
//
