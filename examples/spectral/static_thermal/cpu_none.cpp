// =============================================================================
// examples/spectral/static_thermal/cpu_none.cpp
//
// spectral | static thermal | CPU (OpenMP) | full Hilbert (no symmetry)
//
// static thermodynamic averages at a single T via qed.thermal. Twin: examples/spectral/static_thermal/cpu_none.py
//
...
int main(int argc, char** argv) {
    ...
    // gs_E    = -2.6207
    // T_probe = 1.5000  E = -1.2586  Cv = 0.9642
    // ===========================================================================
    return 0;
}
