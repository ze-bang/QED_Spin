// =============================================================================
// examples/spectral/static_thermal/mpi_none.cpp
//
// spectral | static thermal | MPI (distributed) | full Hilbert (no symmetry)
//
// static thermodynamic averages at a single T via qed.thermal. Twin: examples/spectral/static_thermal/mpi_none.py
//
