// =============================================================================
// examples/spectral/static_thermal/mpi_sz.cpp
//
// spectral | static thermal | MPI (distributed) | U(1)-Sz, half-filled (Sz=0, n_up=N/2)
//
// static thermodynamic averages at a single T via qed.thermal. Twin: examples/spectral/static_thermal/mpi_sz.py
//
