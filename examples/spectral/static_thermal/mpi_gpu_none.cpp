// =============================================================================
// examples/spectral/static_thermal/mpi_gpu_none.cpp
//
// spectral | static thermal | multi-rank multi-GPU (NCCL) | full Hilbert (no symmetry)
//
// static thermodynamic averages at a single T via qed.thermal. Twin: examples/spectral/static_thermal/mpi_gpu_none.py
//
