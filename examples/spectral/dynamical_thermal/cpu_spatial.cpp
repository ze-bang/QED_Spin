// =============================================================================
// examples/spectral/dynamical_thermal/cpu_spatial.cpp
//
// spectral | dynamical thermal | CPU (OpenMP) | cyclic translation group Z_N
//
// finite-T S_zz(omega, T) at three (T, omega) probe points. Twin: examples/spectral/dynamical_thermal/cpu_spatial.py
//
