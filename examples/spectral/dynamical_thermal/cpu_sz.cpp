// =============================================================================
// examples/spectral/dynamical_thermal/cpu_sz.cpp
//
// spectral | dynamical thermal | CPU (OpenMP) | U(1)-Sz, half-filled (Sz=0, n_up=N/2)
//
// finite-T S_zz(omega, T) at three (T, omega) probe points. Twin: examples/spectral/dynamical_thermal/cpu_sz.py
//
