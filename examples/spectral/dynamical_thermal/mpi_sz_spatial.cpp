// =============================================================================
// examples/spectral/dynamical_thermal/mpi_sz_spatial.cpp
//
// spectral | dynamical thermal | MPI (distributed) | U(1)-Sz x cyclic translation
//
// finite-T S_zz(omega, T) at three (T, omega) probe points. Twin: examples/spectral/dynamical_thermal/mpi_sz_spatial.py
//
