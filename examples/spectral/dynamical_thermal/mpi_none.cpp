// =============================================================================
// examples/spectral/dynamical_thermal/mpi_none.cpp
//
// spectral | dynamical thermal | MPI (distributed) | full Hilbert (no symmetry)
//
// finite-T S_zz(omega, T) at three (T, omega) probe points. Twin: examples/spectral/dynamical_thermal/mpi_none.py
//
