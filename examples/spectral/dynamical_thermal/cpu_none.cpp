// =============================================================================
// examples/spectral/dynamical_thermal/cpu_none.cpp
//
// spectral | dynamical thermal | CPU (OpenMP) | full Hilbert (no symmetry)
//
// finite-T S_zz(omega, T) at three (T, omega) probe points. Twin: examples/spectral/dynamical_thermal/cpu_none.py
//
