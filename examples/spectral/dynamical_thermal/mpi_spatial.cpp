// =============================================================================
// examples/spectral/dynamical_thermal/mpi_spatial.cpp
//
// spectral | dynamical thermal | MPI (distributed) | cyclic translation group Z_N
//
// finite-T S_zz(omega, T) at three (T, omega) probe points. Twin: examples/spectral/dynamical_thermal/mpi_spatial.py
//
