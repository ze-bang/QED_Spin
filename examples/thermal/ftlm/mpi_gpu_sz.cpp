// =============================================================================
// examples/thermal/ftlm/mpi_gpu_sz.cpp
//
// thermal | FTLM | multi-rank multi-GPU (NCCL) | U(1)-Sz auto-decomposition
//
// Finite-Temperature Lanczos: random vectors x Lanczos. Twin: examples/thermal/ftlm/mpi_gpu_sz.py
//
