// =============================================================================
// examples/thermal/ftlm/mpi_sz.cpp
//
// thermal | FTLM | MPI (distributed) | U(1)-Sz auto-decomposition
//
// Finite-Temperature Lanczos: random vectors x Lanczos. Twin: examples/thermal/ftlm/mpi_sz.py
//
