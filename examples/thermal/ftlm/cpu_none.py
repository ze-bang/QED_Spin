...
Finite-Temperature Lanczos: random vectors x Lanczos. Twin: ``examples/thermal/ftlm/cpu_none.cpp``.
...
# gs_E    = -3.6480
# T[0]    = 0.1000  E = -3.6422  Cv = 0.4655
# T[mid]  = 5.7571  E = -1.0841  Cv = 0.7120
# T[-1]   = 10.0000  E = -0.1859  Cv = 0.0166
# ===========================================================================
