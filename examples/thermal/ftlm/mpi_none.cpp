// =============================================================================
// examples/thermal/ftlm/mpi_none.cpp
//
// thermal | FTLM | MPI (distributed) | full Hilbert (no symmetry)
//
// Finite-Temperature Lanczos: random vectors x Lanczos. Twin: examples/thermal/ftlm/mpi_none.py
//
