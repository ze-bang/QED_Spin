// =============================================================================
// examples/thermal/ftlm/mpi_spatial.cpp
//
// thermal | FTLM | MPI (distributed) | cyclic translation group Z_N (spatial symmetry)
//
// Finite-Temperature Lanczos: random vectors x Lanczos. Twin: examples/thermal/ftlm/mpi_spatial.py
//
