// =============================================================================
// examples/thermal/ftlm/mpi_gpu_spatial.cpp
//
// thermal | FTLM | multi-rank multi-GPU (NCCL) | cyclic translation group Z_N (spatial symmetry)
//
// Finite-Temperature Lanczos: random vectors x Lanczos. Twin: examples/thermal/ftlm/mpi_gpu_spatial.py
//
