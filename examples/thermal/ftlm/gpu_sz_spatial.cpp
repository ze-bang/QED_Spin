// =============================================================================
// examples/thermal/ftlm/gpu_sz_spatial.cpp
//
// thermal | FTLM | single GPU (cuBLAS/cuSPARSE) | U(1)-Sz x cyclic translation
//
// Finite-Temperature Lanczos: random vectors x Lanczos. Twin: examples/thermal/ftlm/gpu_sz_spatial.py
//
