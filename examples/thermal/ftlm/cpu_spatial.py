...
Finite-Temperature Lanczos: random vectors x Lanczos. Twin: ``examples/thermal/ftlm/cpu_spatial.cpp``.
...
# gs_E    = -3.6471
# T[0]    = 0.1000  E = -3.6442  Cv = 0.3615
# T[mid]  = 5.7571  E = -1.0153  Cv = 0.6723
# T[-1]   = 10.0000  E = -0.1736  Cv = 0.0157
# ===========================================================================
