// =============================================================================
// examples/thermal/ftlm/cpu_spatial.cpp
//
// thermal | FTLM | CPU (OpenMP) | cyclic translation group Z_N (spatial symmetry)
//
// Finite-Temperature Lanczos: random vectors x Lanczos. Twin: examples/thermal/ftlm/cpu_spatial.py
//
...
int main(int argc, char** argv) {
    ...
    // gs_E    = -3.6468
    // T[0]    = 0.1000  E = -3.6468  Cv = 0.2289
    // T[mid]  = 5.7571  E = -1.1650  Cv = 0.8496
    // T[-1]   = 10.0000  E = -0.1431  Cv = 0.0156
    // ===========================================================================
    return 0;
}
