// =============================================================================
// examples/thermal/ftlm/cpu_sz_spatial.cpp
//
// thermal | FTLM | CPU (OpenMP) | U(1)-Sz x cyclic translation
//
// Finite-Temperature Lanczos: random vectors x Lanczos. Twin: examples/thermal/ftlm/cpu_sz_spatial.py
//
...
int main(int argc, char** argv) {
    ...
    // gs_E    = -3.6408
    // T[0]    = 0.1000  E = -3.6408  Cv = 0.5360
    // T[mid]  = 5.7571  E = -1.1783  Cv = 0.8536
    // T[-1]   = 10.0000  E = -0.1644  Cv = 0.0153
    // ===========================================================================
    return 0;
}
