// =============================================================================
// examples/thermal/ftlm/mpi_gpu_sz_spatial.cpp
//
// thermal | FTLM | multi-rank multi-GPU (NCCL) | U(1)-Sz x cyclic translation
//
// Finite-Temperature Lanczos: random vectors x Lanczos. Twin: examples/thermal/ftlm/mpi_gpu_sz_spatial.py
//
