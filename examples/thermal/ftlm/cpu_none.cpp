// =============================================================================
// examples/thermal/ftlm/cpu_none.cpp
//
// thermal | FTLM | CPU (OpenMP) | full Hilbert (no symmetry)
//
// Finite-Temperature Lanczos: random vectors x Lanczos. Twin: examples/thermal/ftlm/cpu_none.py
//
...
int main(int argc, char** argv) {
    ...
    // gs_E    = -3.6434
    // T[0]    = 0.1000  E = -3.6434  Cv = 0.4033
    // T[mid]  = 5.7571  E = -1.1315  Cv = 0.8317
    // T[-1]   = 10.0000  E = -0.1408  Cv = 0.0151
    // ===========================================================================
    return 0;
}
