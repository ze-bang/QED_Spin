...
Finite-Temperature Lanczos: random vectors x Lanczos. Twin: ``examples/thermal/ftlm/cpu_sz_spatial.cpp``.
...
# gs_E    = -3.6459
# T[0]    = 0.1000  E = -3.6376  Cv = 0.6934
# T[mid]  = 5.7571  E = -1.0879  Cv = 0.6908
# T[-1]   = 10.0000  E = -0.2188  Cv = 0.0162
# ===========================================================================
