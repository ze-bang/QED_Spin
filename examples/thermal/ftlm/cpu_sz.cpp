// =============================================================================
// examples/thermal/ftlm/cpu_sz.cpp
//
// thermal | FTLM | CPU (OpenMP) | U(1)-Sz auto-decomposition
//
// Finite-Temperature Lanczos: random vectors x Lanczos. Twin: examples/thermal/ftlm/cpu_sz.py
//
...
int main(int argc, char** argv) {
    ...
    // gs_E    = -3.6363
    // T[0]    = 0.1000  E = -3.6363  Cv = 0.7630
    // T[mid]  = 5.7571  E = -1.1995  Cv = 0.8398
    // T[-1]   = 10.0000  E = -0.1784  Cv = 0.0156
    // ===========================================================================
    return 0;
}
