// =============================================================================
// examples/thermal/ftlm/mpi_sz_spatial.cpp
//
// thermal | FTLM | MPI (distributed) | U(1)-Sz x cyclic translation
//
// Finite-Temperature Lanczos: random vectors x Lanczos. Twin: examples/thermal/ftlm/mpi_sz_spatial.py
//
