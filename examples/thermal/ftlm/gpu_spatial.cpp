// =============================================================================
// examples/thermal/ftlm/gpu_spatial.cpp
//
// thermal | FTLM | single GPU (cuBLAS/cuSPARSE) | cyclic translation group Z_N (spatial symmetry)
//
// Finite-Temperature Lanczos: random vectors x Lanczos. Twin: examples/thermal/ftlm/gpu_spatial.py
//
