// =============================================================================
// examples/thermal/ltlm/cpu_none.cpp
//
// thermal | LTLM | CPU (OpenMP) | full Hilbert (no symmetry)
//
// Low-Temperature Lanczos Method. Twin: examples/thermal/ltlm/cpu_none.py
//
