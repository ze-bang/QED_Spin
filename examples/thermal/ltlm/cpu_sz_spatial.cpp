// =============================================================================
// examples/thermal/ltlm/cpu_sz_spatial.cpp
//
// thermal | LTLM | CPU (OpenMP) | U(1)-Sz x cyclic translation
//
// Low-Temperature Lanczos Method. Twin: examples/thermal/ltlm/cpu_sz_spatial.py
//
