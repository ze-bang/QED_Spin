// =============================================================================
// examples/thermal/ltlm/gpu_sz_spatial.cpp
//
// thermal | LTLM | single GPU (cuBLAS/cuSPARSE) | U(1)-Sz x cyclic translation
//
// Low-Temperature Lanczos Method. Twin: examples/thermal/ltlm/gpu_sz_spatial.py
//
