// =============================================================================
// examples/thermal/ltlm/gpu_none.cpp
//
// thermal | LTLM | single GPU (cuBLAS/cuSPARSE) | full Hilbert (no symmetry)
//
// Low-Temperature Lanczos Method. Twin: examples/thermal/ltlm/gpu_none.py
//
