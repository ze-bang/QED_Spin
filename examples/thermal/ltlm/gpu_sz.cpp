// =============================================================================
// examples/thermal/ltlm/gpu_sz.cpp
//
// thermal | LTLM | single GPU (cuBLAS/cuSPARSE) | U(1)-Sz auto-decomposition
//
// Low-Temperature Lanczos Method. Twin: examples/thermal/ltlm/gpu_sz.py
//
