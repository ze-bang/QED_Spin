// =============================================================================
// examples/thermal/ltlm/cpu_spatial.cpp
//
// thermal | LTLM | CPU (OpenMP) | cyclic translation group Z_N (spatial symmetry)
//
// Low-Temperature Lanczos Method. Twin: examples/thermal/ltlm/cpu_spatial.py
//
...
int main(int argc, char** argv) {
    ...
    // gs_E    = -3.6511
    // T[0]    = 0.1000  E = -3.6511  Cv = 0.0000
    // T[mid]  = 5.7571  E = -3.6511  Cv = 0.0000
    // T[-1]   = 10.0000  E = -3.6511  Cv = 0.0000
    // ===========================================================================
    return 0;
}
