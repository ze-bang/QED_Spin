// =============================================================================
// examples/thermal/ctpq/cpu_sz.cpp
//
// thermal | cTPQ | CPU (OpenMP) | U(1)-Sz auto-decomposition
//
// Canonical Thermal Pure Quantum (Krylov imaginary-time). Twin: examples/thermal/ctpq/cpu_sz.py
//
...
int main(int argc, char** argv) {
    ...
    // gs_E    = -3.6483
    // T[0]    = 0.1000  E = -3.6338  Cv = 0.8480
    // T[mid]  = 5.7571  E = -0.5786  Cv = 0.0506
    // T[-1]   = 10.0000  E = -0.3344  Cv = 0.0162
    // ===========================================================================
    return 0;
}
