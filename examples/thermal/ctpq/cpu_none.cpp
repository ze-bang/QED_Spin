// =============================================================================
// examples/thermal/ctpq/cpu_none.cpp
//
// thermal | cTPQ | CPU (OpenMP) | full Hilbert (no symmetry)
//
// Canonical Thermal Pure Quantum (Krylov imaginary-time). Twin: examples/thermal/ctpq/cpu_none.py
//
...
int main(int argc, char** argv) {
    ...
    // gs_E    = -3.6488
    // T[0]    = 0.1000  E = -3.5970  Cv = 1.7960
    // T[mid]  = 5.7571  E = -0.5246  Cv = 0.0488
    // T[-1]   = 10.0000  E = -0.2918  Cv = 0.0153
    // ===========================================================================
    return 0;
}
