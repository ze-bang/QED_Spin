// =============================================================================
// examples/thermal/ctpq/gpu_spatial.cpp
//
// thermal | cTPQ | single GPU (cuBLAS/cuSPARSE) | cyclic translation group Z_N (spatial symmetry)
//
// Canonical Thermal Pure Quantum (Krylov imaginary-time). Twin: examples/thermal/ctpq/gpu_spatial.py
//
