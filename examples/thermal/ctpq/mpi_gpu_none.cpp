// =============================================================================
// examples/thermal/ctpq/mpi_gpu_none.cpp
//
// thermal | cTPQ | multi-rank multi-GPU (NCCL) | full Hilbert (no symmetry)
//
// Canonical Thermal Pure Quantum (Krylov imaginary-time). Twin: examples/thermal/ctpq/mpi_gpu_none.py
//
