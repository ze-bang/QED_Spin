// =============================================================================
// examples/thermal/ctpq/mpi_spatial.cpp
//
// thermal | cTPQ | MPI (distributed) | cyclic translation group Z_N (spatial symmetry)
//
// Canonical Thermal Pure Quantum (Krylov imaginary-time). Twin: examples/thermal/ctpq/mpi_spatial.py
//
