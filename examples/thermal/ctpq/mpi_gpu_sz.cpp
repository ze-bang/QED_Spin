// =============================================================================
// examples/thermal/ctpq/mpi_gpu_sz.cpp
//
// thermal | cTPQ | multi-rank multi-GPU (NCCL) | U(1)-Sz auto-decomposition
//
// Canonical Thermal Pure Quantum (Krylov imaginary-time). Twin: examples/thermal/ctpq/mpi_gpu_sz.py
//
