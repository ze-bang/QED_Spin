// =============================================================================
// examples/thermal/ctpq/gpu_none.cpp
//
// thermal | cTPQ | single GPU (cuBLAS/cuSPARSE) | full Hilbert (no symmetry)
//
// Canonical Thermal Pure Quantum (Krylov imaginary-time). Twin: examples/thermal/ctpq/gpu_none.py
//
