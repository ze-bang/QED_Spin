// =============================================================================
// examples/thermal/ctpq/gpu_sz_spatial.cpp
//
// thermal | cTPQ | single GPU (cuBLAS/cuSPARSE) | U(1)-Sz x cyclic translation
//
// Canonical Thermal Pure Quantum (Krylov imaginary-time). Twin: examples/thermal/ctpq/gpu_sz_spatial.py
//
