...
Canonical Thermal Pure Quantum (Krylov imaginary-time). Twin: ``examples/thermal/ctpq/cpu_sz_spatial.cpp``.
...
# gs_E    = -3.6511
# T[0]    = 0.1000  E = -3.6455  Cv = 0.2880
# T[mid]  = 5.7571  E = 0.0689  Cv = 0.0563
# T[-1]   = 10.0000  E = 0.2829  Cv = 0.0172
# ===========================================================================
