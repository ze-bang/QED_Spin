...
Canonical Thermal Pure Quantum (Krylov imaginary-time). Twin: ``examples/thermal/ctpq/cpu_sz.cpp``.
...
# gs_E    = -3.6511
# T[0]    = 0.1000  E = -3.6454  Cv = 0.2965
# T[mid]  = 5.7571  E = -0.0149  Cv = 0.0544
# T[-1]   = 10.0000  E = 0.1931  Cv = 0.0167
# ===========================================================================
