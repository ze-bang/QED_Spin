// =============================================================================
// examples/thermal/ctpq/mpi_sz_spatial.cpp
//
// thermal | cTPQ | MPI (distributed) | U(1)-Sz x cyclic translation
//
// Canonical Thermal Pure Quantum (Krylov imaginary-time). Twin: examples/thermal/ctpq/mpi_sz_spatial.py
//
