// =============================================================================
// examples/thermal/ctpq/cpu_sz_spatial.cpp
//
// thermal | cTPQ | CPU (OpenMP) | U(1)-Sz x cyclic translation
//
// Canonical Thermal Pure Quantum (Krylov imaginary-time). Twin: examples/thermal/ctpq/cpu_sz_spatial.py
//
...
int main(int argc, char** argv) {
    ...
    // gs_E    = -3.6221
    // T[0]    = 0.1000  E = -3.6176  Cv = 1.6523
    // T[mid]  = 5.7571  E = -0.5692  Cv = 0.0502
    // T[-1]   = 10.0000  E = -0.3255  Cv = 0.0163
    // ===========================================================================
    return 0;
}
