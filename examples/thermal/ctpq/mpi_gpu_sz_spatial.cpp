// =============================================================================
// examples/thermal/ctpq/mpi_gpu_sz_spatial.cpp
//
// thermal | cTPQ | multi-rank multi-GPU (NCCL) | U(1)-Sz x cyclic translation
//
// Canonical Thermal Pure Quantum (Krylov imaginary-time). Twin: examples/thermal/ctpq/mpi_gpu_sz_spatial.py
//
