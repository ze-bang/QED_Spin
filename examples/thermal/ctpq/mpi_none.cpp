// =============================================================================
// examples/thermal/ctpq/mpi_none.cpp
//
// thermal | cTPQ | MPI (distributed) | full Hilbert (no symmetry)
//
// Canonical Thermal Pure Quantum (Krylov imaginary-time). Twin: examples/thermal/ctpq/mpi_none.py
//
