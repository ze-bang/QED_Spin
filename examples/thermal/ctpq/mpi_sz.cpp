// =============================================================================
// examples/thermal/ctpq/mpi_sz.cpp
//
// thermal | cTPQ | MPI (distributed) | U(1)-Sz auto-decomposition
//
// Canonical Thermal Pure Quantum (Krylov imaginary-time). Twin: examples/thermal/ctpq/mpi_sz.py
//
