// =============================================================================
// examples/thermal/ctpq/mpi_gpu_spatial.cpp
//
// thermal | cTPQ | multi-rank multi-GPU (NCCL) | cyclic translation group Z_N (spatial symmetry)
//
// Canonical Thermal Pure Quantum (Krylov imaginary-time). Twin: examples/thermal/ctpq/mpi_gpu_spatial.py
//
