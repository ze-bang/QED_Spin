// =============================================================================
// examples/thermal/ctpq/cpu_spatial.cpp
//
// thermal | cTPQ | CPU (OpenMP) | cyclic translation group Z_N (spatial symmetry)
//
// Canonical Thermal Pure Quantum (Krylov imaginary-time). Twin: examples/thermal/ctpq/cpu_spatial.py
//
...
int main(int argc, char** argv) {
    ...
    // gs_E    = -3.6481
    // T[0]    = 0.1000  E = -3.5924  Cv = 2.1395
    // T[mid]  = 5.7571  E = -0.4931  Cv = 0.0480
    // T[-1]   = 10.0000  E = -0.2637  Cv = 0.0151
    // ===========================================================================
    return 0;
}
