// =============================================================================
// examples/thermal/ctpq/gpu_sz.cpp
//
// thermal | cTPQ | single GPU (cuBLAS/cuSPARSE) | U(1)-Sz auto-decomposition
//
// Canonical Thermal Pure Quantum (Krylov imaginary-time). Twin: examples/thermal/ctpq/gpu_sz.py
//
