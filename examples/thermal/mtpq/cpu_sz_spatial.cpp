// =============================================================================
// examples/thermal/mtpq/cpu_sz_spatial.cpp
//
// thermal | mTPQ | CPU (OpenMP) | U(1)-Sz x cyclic translation
//
// Micro-canonical Thermal Pure Quantum (Taylor truncation). Twin: examples/thermal/mtpq/cpu_sz_spatial.py
//
...
int main(int argc, char** argv) {
    ...
    // gs_E    = -3.6173
    // T[0]    = 0.1000  E = -3.5976  Cv = 2.8010
    // T[mid]  = 5.7571  E = -0.2610  Cv = 0.0512
    // T[-1]   = 10.0000  E = -0.1376  Cv = 0.0164
    // ===========================================================================
    return 0;
}
