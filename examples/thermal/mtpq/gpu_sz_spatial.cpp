// =============================================================================
// examples/thermal/mtpq/gpu_sz_spatial.cpp
//
// thermal | mTPQ | single GPU (cuBLAS/cuSPARSE) | U(1)-Sz x cyclic translation
//
// Micro-canonical Thermal Pure Quantum (Taylor truncation). Twin: examples/thermal/mtpq/gpu_sz_spatial.py
//
