...
Micro-canonical Thermal Pure Quantum (Taylor truncation). Twin: ``examples/thermal/mtpq/cpu_sz_spatial.cpp``.
...
# gs_E    = -3.6508
# T[0]    = 0.1000  E = -3.6413  Cv = 0.5204
# T[mid]  = 5.7571  E = 0.9165  Cv = 0.0171
# T[-1]   = 10.0000  E = 0.9580  Cv = 0.0056
# ===========================================================================
