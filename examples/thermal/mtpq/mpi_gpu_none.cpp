// =============================================================================
// examples/thermal/mtpq/mpi_gpu_none.cpp
//
// thermal | mTPQ | multi-rank multi-GPU (NCCL) | full Hilbert (no symmetry)
//
// Micro-canonical Thermal Pure Quantum (Taylor truncation). Twin: examples/thermal/mtpq/mpi_gpu_none.py
//
