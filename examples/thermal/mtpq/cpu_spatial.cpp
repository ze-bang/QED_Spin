// =============================================================================
// examples/thermal/mtpq/cpu_spatial.cpp
//
// thermal | mTPQ | CPU (OpenMP) | cyclic translation group Z_N (spatial symmetry)
//
// Micro-canonical Thermal Pure Quantum (Taylor truncation). Twin: examples/thermal/mtpq/cpu_spatial.py
//
...
int main(int argc, char** argv) {
    ...
    // gs_E    = -3.6252
    // T[0]    = 0.1000  E = -3.5241  Cv = 4.9363
    // T[mid]  = 5.7571  E = -0.2327  Cv = 0.0439
    // T[-1]   = 10.0000  E = -0.1264  Cv = 0.0142
    // ===========================================================================
    return 0;
}
