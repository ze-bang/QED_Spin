// =============================================================================
// examples/thermal/mtpq/mpi_spatial.cpp
//
// thermal | mTPQ | MPI (distributed) | cyclic translation group Z_N (spatial symmetry)
//
// Micro-canonical Thermal Pure Quantum (Taylor truncation). Twin: examples/thermal/mtpq/mpi_spatial.py
//
