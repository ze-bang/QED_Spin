// =============================================================================
// examples/thermal/mtpq/mpi_gpu_spatial.cpp
//
// thermal | mTPQ | multi-rank multi-GPU (NCCL) | cyclic translation group Z_N (spatial symmetry)
//
// Micro-canonical Thermal Pure Quantum (Taylor truncation). Twin: examples/thermal/mtpq/mpi_gpu_spatial.py
//
