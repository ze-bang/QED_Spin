...
Micro-canonical Thermal Pure Quantum (Taylor truncation). Twin: ``examples/thermal/mtpq/cpu_sz.cpp``.
...
# gs_E    = -3.6505
# T[0]    = 0.1000  E = -3.6428  Cv = 0.4395
# T[mid]  = 5.7571  E = 0.0492  Cv = 0.0314
# T[-1]   = 10.0000  E = 0.1260  Cv = 0.0104
# ===========================================================================
