...
Micro-canonical Thermal Pure Quantum (Taylor truncation). Twin: ``examples/thermal/mtpq/cpu_spatial.cpp``.
...
# gs_E    = -3.6500
# T[0]    = 0.1000  E = -3.6317  Cv = 0.9952
# T[mid]  = 5.7571  E = 0.0727  Cv = 0.0465
# T[-1]   = 10.0000  E = 0.1831  Cv = 0.0146
# ===========================================================================
