// =============================================================================
// examples/thermal/mtpq/mpi_gpu_sz.cpp
//
// thermal | mTPQ | multi-rank multi-GPU (NCCL) | U(1)-Sz auto-decomposition
//
// Micro-canonical Thermal Pure Quantum (Taylor truncation). Twin: examples/thermal/mtpq/mpi_gpu_sz.py
//
