// =============================================================================
// examples/thermal/mtpq/gpu_none.cpp
//
// thermal | mTPQ | single GPU (cuBLAS/cuSPARSE) | full Hilbert (no symmetry)
//
// Micro-canonical Thermal Pure Quantum (Taylor truncation). Twin: examples/thermal/mtpq/gpu_none.py
//
