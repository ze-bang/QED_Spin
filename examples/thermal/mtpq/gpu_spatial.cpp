// =============================================================================
// examples/thermal/mtpq/gpu_spatial.cpp
//
// thermal | mTPQ | single GPU (cuBLAS/cuSPARSE) | cyclic translation group Z_N (spatial symmetry)
//
// Micro-canonical Thermal Pure Quantum (Taylor truncation). Twin: examples/thermal/mtpq/gpu_spatial.py
//
