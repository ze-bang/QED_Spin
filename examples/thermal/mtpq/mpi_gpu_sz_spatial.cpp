// =============================================================================
// examples/thermal/mtpq/mpi_gpu_sz_spatial.cpp
//
// thermal | mTPQ | multi-rank multi-GPU (NCCL) | U(1)-Sz x cyclic translation
//
// Micro-canonical Thermal Pure Quantum (Taylor truncation). Twin: examples/thermal/mtpq/mpi_gpu_sz_spatial.py
//
