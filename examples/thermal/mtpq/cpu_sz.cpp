// =============================================================================
// examples/thermal/mtpq/cpu_sz.cpp
//
// thermal | mTPQ | CPU (OpenMP) | U(1)-Sz auto-decomposition
//
// Micro-canonical Thermal Pure Quantum (Taylor truncation). Twin: examples/thermal/mtpq/cpu_sz.py
//
...
int main(int argc, char** argv) {
    ...
    // gs_E    = -3.6327
    // T[0]    = 0.1000  E = -3.6007  Cv = 2.5104
    // T[mid]  = 5.7571  E = -0.2279  Cv = 0.0517
    // T[-1]   = 10.0000  E = -0.1037  Cv = 0.0165
    // ===========================================================================
    return 0;
}
