// =============================================================================
// examples/thermal/mtpq/mpi_sz_spatial.cpp
//
// thermal | mTPQ | MPI (distributed) | U(1)-Sz x cyclic translation
//
// Micro-canonical Thermal Pure Quantum (Taylor truncation). Twin: examples/thermal/mtpq/mpi_sz_spatial.py
//
