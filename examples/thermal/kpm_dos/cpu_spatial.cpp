// =============================================================================
// examples/thermal/kpm_dos/cpu_spatial.cpp
//
// thermal | KPM-DOS | CPU (OpenMP) | cyclic translation group Z_N (spatial symmetry)
//
// Kernel Polynomial Method density of states. Twin: examples/thermal/kpm_dos/cpu_spatial.py
//
...
int main(int argc, char** argv) {
    ...
    // gs_E    = -3.6511
    // T[0]    = 0.1000  E = -3.6486  Cv = 0.3697
    // T[mid]  = 5.7571  E = -0.2493  Cv = 0.0495
    // T[-1]   = 10.0000  E = -0.1300  Cv = 0.0160
    // ===========================================================================
    return 0;
}
