// =============================================================================
// examples/thermal/kpm_dos/gpu_sz_spatial.cpp
//
// thermal | KPM-DOS | single GPU (cuBLAS/cuSPARSE) | U(1)-Sz x cyclic translation
//
// Kernel Polynomial Method density of states. Twin: examples/thermal/kpm_dos/gpu_sz_spatial.py
//
