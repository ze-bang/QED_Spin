// =============================================================================
// examples/thermal/kpm_dos/cpu_sz_spatial.cpp
//
// thermal | KPM-DOS | CPU (OpenMP) | U(1)-Sz x cyclic translation
//
// Kernel Polynomial Method density of states. Twin: examples/thermal/kpm_dos/cpu_sz_spatial.py
//
...
int main(int argc, char** argv) {
    ...
    // gs_E    = -3.6511
    // T[0]    = 0.1000  E = -3.6487  Cv = 0.3641
    // T[mid]  = 5.7571  E = -0.2772  Cv = 0.0487
    // T[-1]   = 10.0000  E = -0.1597  Cv = 0.0157
    // ===========================================================================
    return 0;
}
