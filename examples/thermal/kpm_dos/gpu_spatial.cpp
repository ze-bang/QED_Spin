// =============================================================================
// examples/thermal/kpm_dos/gpu_spatial.cpp
//
// thermal | KPM-DOS | single GPU (cuBLAS/cuSPARSE) | cyclic translation group Z_N (spatial symmetry)
//
// Kernel Polynomial Method density of states. Twin: examples/thermal/kpm_dos/gpu_spatial.py
//
