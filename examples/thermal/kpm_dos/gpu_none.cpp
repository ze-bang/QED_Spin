// =============================================================================
// examples/thermal/kpm_dos/gpu_none.cpp
//
// thermal | KPM-DOS | single GPU (cuBLAS/cuSPARSE) | full Hilbert (no symmetry)
//
// Kernel Polynomial Method density of states. Twin: examples/thermal/kpm_dos/gpu_none.py
//
