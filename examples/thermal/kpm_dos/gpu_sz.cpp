// =============================================================================
// examples/thermal/kpm_dos/gpu_sz.cpp
//
// thermal | KPM-DOS | single GPU (cuBLAS/cuSPARSE) | U(1)-Sz auto-decomposition
//
// Kernel Polynomial Method density of states. Twin: examples/thermal/kpm_dos/gpu_sz.py
//
