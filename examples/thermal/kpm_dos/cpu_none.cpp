// =============================================================================
// examples/thermal/kpm_dos/cpu_none.cpp
//
// thermal | KPM-DOS | CPU (OpenMP) | full Hilbert (no symmetry)
//
// Kernel Polynomial Method density of states. Twin: examples/thermal/kpm_dos/cpu_none.py
//
...
int main(int argc, char** argv) {
    ...
    // gs_E    = -3.6511
    // T[0]    = 0.1000  E = -3.6456  Cv = 0.5194
    // T[mid]  = 5.7571  E = -0.2795  Cv = 0.0495
    // T[-1]   = 10.0000  E = -0.1603  Cv = 0.0159
    // ===========================================================================
    return 0;
}
