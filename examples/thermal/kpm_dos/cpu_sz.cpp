// =============================================================================
// examples/thermal/kpm_dos/cpu_sz.cpp
//
// thermal | KPM-DOS | CPU (OpenMP) | U(1)-Sz auto-decomposition
//
// Kernel Polynomial Method density of states. Twin: examples/thermal/kpm_dos/cpu_sz.py
//
...
int main(int argc, char** argv) {
    ...
    // gs_E    = -3.6511
    // T[0]    = 0.1000  E = -3.6411  Cv = 0.7534
    // T[mid]  = 5.7571  E = -0.2427  Cv = 0.0484
    // T[-1]   = 10.0000  E = -0.1261  Cv = 0.0156
    // ===========================================================================
    return 0;
}
