// =============================================================================
// examples/solve/full/gpu_sz_spatial.cpp
//
// solve | FULL | single GPU (cuBLAS/cuSPARSE) | U(1)-Sz x cyclic translation (Sz=0)
//
// dense diagonalisation (zheevd) of the full Hamiltonian. Twin: examples/solve/full/gpu_sz_spatial.py
//
