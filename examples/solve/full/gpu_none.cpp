// =============================================================================
// examples/solve/full/gpu_none.cpp
//
// solve | FULL | single GPU (cuBLAS/cuSPARSE) | full Hilbert (no symmetry)
//
// dense diagonalisation (zheevd) of the full Hamiltonian. Twin: examples/solve/full/gpu_none.py
//
