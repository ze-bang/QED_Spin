// =============================================================================
// examples/solve/full/cpu_none.cpp
//
// solve | FULL | CPU (OpenMP) | full Hilbert (no symmetry)
//
// dense diagonalisation (zheevd) of the full Hamiltonian. Twin: examples/solve/full/cpu_none.py
//
