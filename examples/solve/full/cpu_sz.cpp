// =============================================================================
// examples/solve/full/cpu_sz.cpp
//
// solve | FULL | CPU (OpenMP) | U(1)-Sz, half-filled sector (Sz=0, n_up=N/2)
//
// dense diagonalisation (zheevd) of the full Hamiltonian. Twin: examples/solve/full/cpu_sz.py
//
