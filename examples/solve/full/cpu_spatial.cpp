// =============================================================================
// examples/solve/full/cpu_spatial.cpp
//
// solve | FULL | CPU (OpenMP) | cyclic translation group Z_N (spatial symmetry)
//
// dense diagonalisation (zheevd) of the full Hamiltonian. Twin: examples/solve/full/cpu_spatial.py
//
