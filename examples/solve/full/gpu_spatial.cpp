// =============================================================================
// examples/solve/full/gpu_spatial.cpp
//
// solve | FULL | single GPU (cuBLAS/cuSPARSE) | cyclic translation group Z_N (spatial symmetry)
//
// dense diagonalisation (zheevd) of the full Hamiltonian. Twin: examples/solve/full/gpu_spatial.py
//
