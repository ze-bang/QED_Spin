// =============================================================================
// examples/solve/full/cpu_sz_spatial.cpp
//
// solve | FULL | CPU (OpenMP) | U(1)-Sz x cyclic translation (Sz=0)
//
// dense diagonalisation (zheevd) of the full Hamiltonian. Twin: examples/solve/full/cpu_sz_spatial.py
//
