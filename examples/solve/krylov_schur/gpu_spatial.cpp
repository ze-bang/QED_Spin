// =============================================================================
// examples/solve/krylov_schur/gpu_spatial.cpp
//
// solve | KRYLOV_SCHUR | single GPU (cuBLAS/cuSPARSE) | cyclic translation group Z_N (spatial symmetry)
//
// thick-restart Krylov-Schur for 5 lowest eigenvalues. Twin: examples/solve/krylov_schur/gpu_spatial.py
//
