// =============================================================================
// examples/solve/krylov_schur/mpi_gpu_sz_spatial.cpp
//
// solve | KRYLOV_SCHUR | multi-rank multi-GPU (NCCL) | U(1)-Sz x cyclic translation (Sz=0)
//
// thick-restart Krylov-Schur for 5 lowest eigenvalues. Twin: examples/solve/krylov_schur/mpi_gpu_sz_spatial.py
//
