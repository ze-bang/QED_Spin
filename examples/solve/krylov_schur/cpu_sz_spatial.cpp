// =============================================================================
// examples/solve/krylov_schur/cpu_sz_spatial.cpp
//
// solve | KRYLOV_SCHUR | CPU (OpenMP) | U(1)-Sz x cyclic translation (Sz=0)
//
// thick-restart Krylov-Schur for 5 lowest eigenvalues. Twin: examples/solve/krylov_schur/cpu_sz_spatial.py
//
