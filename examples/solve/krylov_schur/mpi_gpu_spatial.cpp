// =============================================================================
// examples/solve/krylov_schur/mpi_gpu_spatial.cpp
//
// solve | KRYLOV_SCHUR | multi-rank multi-GPU (NCCL) | cyclic translation group Z_N (spatial symmetry)
//
// thick-restart Krylov-Schur for 5 lowest eigenvalues. Twin: examples/solve/krylov_schur/mpi_gpu_spatial.py
//
