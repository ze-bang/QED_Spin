// =============================================================================
// examples/solve/krylov_schur/mpi_gpu_none.cpp
//
// solve | KRYLOV_SCHUR | multi-rank multi-GPU (NCCL) | full Hilbert (no symmetry)
//
// thick-restart Krylov-Schur for 5 lowest eigenvalues. Twin: examples/solve/krylov_schur/mpi_gpu_none.py
//
