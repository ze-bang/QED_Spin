// =============================================================================
// examples/solve/krylov_schur/mpi_spatial.cpp
//
// solve | KRYLOV_SCHUR | MPI (distributed) | cyclic translation group Z_N (spatial symmetry)
//
// thick-restart Krylov-Schur for 5 lowest eigenvalues. Twin: examples/solve/krylov_schur/mpi_spatial.py
//
