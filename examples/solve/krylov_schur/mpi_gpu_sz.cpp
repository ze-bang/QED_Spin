// =============================================================================
// examples/solve/krylov_schur/mpi_gpu_sz.cpp
//
// solve | KRYLOV_SCHUR | multi-rank multi-GPU (NCCL) | U(1)-Sz, half-filled sector (Sz=0, n_up=N/2)
//
// thick-restart Krylov-Schur for 5 lowest eigenvalues. Twin: examples/solve/krylov_schur/mpi_gpu_sz.py
//
