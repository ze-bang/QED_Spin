// =============================================================================
// examples/solve/krylov_schur/mpi_sz.cpp
//
// solve | KRYLOV_SCHUR | MPI (distributed) | U(1)-Sz, half-filled sector (Sz=0, n_up=N/2)
//
// thick-restart Krylov-Schur for 5 lowest eigenvalues. Twin: examples/solve/krylov_schur/mpi_sz.py
//
