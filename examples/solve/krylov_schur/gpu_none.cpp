// =============================================================================
// examples/solve/krylov_schur/gpu_none.cpp
//
// solve | KRYLOV_SCHUR | single GPU (cuBLAS/cuSPARSE) | full Hilbert (no symmetry)
//
// thick-restart Krylov-Schur for 5 lowest eigenvalues. Twin: examples/solve/krylov_schur/gpu_none.py
//
