// =============================================================================
// examples/solve/krylov_schur/cpu_spatial.cpp
//
// solve | KRYLOV_SCHUR | CPU (OpenMP) | cyclic translation group Z_N (spatial symmetry)
//
// thick-restart Krylov-Schur for 5 lowest eigenvalues. Twin: examples/solve/krylov_schur/cpu_spatial.py
//
