// =============================================================================
// examples/solve/lanczos/mpi_spatial.cpp
//
// solve | LANCZOS | MPI (distributed) | cyclic translation group Z_N (spatial symmetry)
//
// single ground-state eigenvalue via Lanczos. Twin: examples/solve/lanczos/mpi_spatial.py
//
