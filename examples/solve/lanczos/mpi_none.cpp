// =============================================================================
// examples/solve/lanczos/mpi_none.cpp
//
// solve | LANCZOS | MPI (distributed) | full Hilbert (no symmetry)
//
// single ground-state eigenvalue via Lanczos. Twin: examples/solve/lanczos/mpi_none.py
//
