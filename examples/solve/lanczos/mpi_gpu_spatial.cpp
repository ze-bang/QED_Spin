// =============================================================================
// examples/solve/lanczos/mpi_gpu_spatial.cpp
//
// solve | LANCZOS | multi-rank multi-GPU (NCCL) | cyclic translation group Z_N (spatial symmetry)
//
// single ground-state eigenvalue via Lanczos. Twin: examples/solve/lanczos/mpi_gpu_spatial.py
//
