// =============================================================================
// examples/solve/lanczos/mpi_gpu_sz.cpp
//
// solve | LANCZOS | multi-rank multi-GPU (NCCL) | U(1)-Sz, half-filled sector (Sz=0, n_up=N/2)
//
// single ground-state eigenvalue via Lanczos. Twin: examples/solve/lanczos/mpi_gpu_sz.py
//
