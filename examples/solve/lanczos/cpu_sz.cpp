// =============================================================================
// examples/solve/lanczos/cpu_sz.cpp
//
// solve | LANCZOS | CPU (OpenMP) | U(1)-Sz, half-filled sector (Sz=0, n_up=N/2)
//
// single ground-state eigenvalue via Lanczos. Twin: examples/solve/lanczos/cpu_sz.py
//
