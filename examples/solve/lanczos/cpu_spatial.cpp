// =============================================================================
// examples/solve/lanczos/cpu_spatial.cpp
//
// solve | LANCZOS | CPU (OpenMP) | cyclic translation group Z_N (spatial symmetry)
//
// single ground-state eigenvalue via Lanczos. Twin: examples/solve/lanczos/cpu_spatial.py
//
