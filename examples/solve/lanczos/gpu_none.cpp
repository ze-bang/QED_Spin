// =============================================================================
// examples/solve/lanczos/gpu_none.cpp
//
// solve | LANCZOS | single GPU (cuBLAS/cuSPARSE) | full Hilbert (no symmetry)
//
// single ground-state eigenvalue via Lanczos. Twin: examples/solve/lanczos/gpu_none.py
//
