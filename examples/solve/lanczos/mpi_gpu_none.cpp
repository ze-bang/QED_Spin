// =============================================================================
// examples/solve/lanczos/mpi_gpu_none.cpp
//
// solve | LANCZOS | multi-rank multi-GPU (NCCL) | full Hilbert (no symmetry)
//
// single ground-state eigenvalue via Lanczos. Twin: examples/solve/lanczos/mpi_gpu_none.py
//
