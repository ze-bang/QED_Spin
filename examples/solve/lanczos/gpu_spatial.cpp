// =============================================================================
// examples/solve/lanczos/gpu_spatial.cpp
//
// solve | LANCZOS | single GPU (cuBLAS/cuSPARSE) | cyclic translation group Z_N (spatial symmetry)
//
// single ground-state eigenvalue via Lanczos. Twin: examples/solve/lanczos/gpu_spatial.py
//
