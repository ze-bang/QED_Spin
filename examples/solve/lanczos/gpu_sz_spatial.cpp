// =============================================================================
// examples/solve/lanczos/gpu_sz_spatial.cpp
//
// solve | LANCZOS | single GPU (cuBLAS/cuSPARSE) | U(1)-Sz x cyclic translation (Sz=0)
//
// single ground-state eigenvalue via Lanczos. Twin: examples/solve/lanczos/gpu_sz_spatial.py
//
