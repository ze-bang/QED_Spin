// =============================================================================
// examples/solve/lanczos/gpu_sz.cpp
//
// solve | LANCZOS | single GPU (cuBLAS/cuSPARSE) | U(1)-Sz, half-filled sector (Sz=0, n_up=N/2)
//
// single ground-state eigenvalue via Lanczos. Twin: examples/solve/lanczos/gpu_sz.py
//
