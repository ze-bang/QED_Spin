// =============================================================================
// examples/solve/block_lanczos/gpu_spatial.cpp
//
// solve | BLOCK_LANCZOS | single GPU (cuBLAS/cuSPARSE) | cyclic translation group Z_N (spatial symmetry)
//
// block-Lanczos for 4 lowest eigenvalues (BLAS-3 path). Twin: examples/solve/block_lanczos/gpu_spatial.py
//
