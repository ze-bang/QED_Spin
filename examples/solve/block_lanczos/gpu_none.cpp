// =============================================================================
// examples/solve/block_lanczos/gpu_none.cpp
//
// solve | BLOCK_LANCZOS | single GPU (cuBLAS/cuSPARSE) | full Hilbert (no symmetry)
//
// block-Lanczos for 4 lowest eigenvalues (BLAS-3 path). Twin: examples/solve/block_lanczos/gpu_none.py
//
