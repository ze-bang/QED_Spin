// =============================================================================
// examples/solve/block_lanczos/gpu_sz_spatial.cpp
//
// solve | BLOCK_LANCZOS | single GPU (cuBLAS/cuSPARSE) | U(1)-Sz x cyclic translation (Sz=0)
//
// block-Lanczos for 4 lowest eigenvalues (BLAS-3 path). Twin: examples/solve/block_lanczos/gpu_sz_spatial.py
//
