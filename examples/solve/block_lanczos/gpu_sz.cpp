// =============================================================================
// examples/solve/block_lanczos/gpu_sz.cpp
//
// solve | BLOCK_LANCZOS | single GPU (cuBLAS/cuSPARSE) | U(1)-Sz, half-filled sector (Sz=0, n_up=N/2)
//
// block-Lanczos for 4 lowest eigenvalues (BLAS-3 path). Twin: examples/solve/block_lanczos/gpu_sz.py
//
