...
% HISTORICAL SNAPSHOT (Jun 2026, branch lanczos-unification-gen1-retire).
% The CURRENT layer-by-layer picture is docs/architecture/UNIFIED_STACK.md
% (post Stage 9-11: one construction lane, one matvec representation, one
% MPI story); this TeX source is kept as the figure of record for that era.
% =============================================================================
