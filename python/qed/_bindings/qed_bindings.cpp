...
PYBIND11_MODULE(_core, m) {
    ...
    m.def("symmetry_adapted_eigenvalues",
          ...
          py::arg("operator"), py::arg("generators"),
          "Full symmetry-adapted spectrum of a Hamiltonian under the (possibly "
          "non-abelian) point group generated by `generators` (a list of site "
          "permutations). Returns a dict with the complete `eigenvalues` (correct "
          "d_Γ degeneracies), per-block (`block_irrep_dim`, `block_size`), and "
          "group info. Reduces by the FULL group including 2-D+ irreps.");
