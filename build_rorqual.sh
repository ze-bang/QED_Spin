#!/bin/bash
# Build QED (C++ ED tree) on Alliance Digital Research Alliance "rorqual-class"
...
# Usage:
#   ./build_rorqual.sh
#   ED_BUILD_JOBS=8 ./build_rorqual.sh
#   ED_BUILD_CLEAN=0 ./build_rorqual.sh   # incremental rebuild (keep ./build)
